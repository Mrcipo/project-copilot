...
const CreateCard: React.FC<CreateCardProps> = ({ onCardCreated }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white p-4 rounded shadow-md text-blue-500 w-full max-w-md mx-auto">
      ...
      <Button type="submit" className="bg-blue-500 text-white px-4 py-2 rounded shadow hover:bg-blue-600 transition w-full">Crear Tarjeta</Button>
    </form>
  );
};
